...
def fixed_dataset() -> pd.DataFrame:
    ...
    flight_list = pd.concat(
        ...
        for file in
        Path("C:/Users/akan2/Onedrive/Documents/Python/FlightTracker/data_set").glob("flightlist_*.csv.gz")
    )
    return flight_list
...
def forming_dataset(*, start_time: str, end_time: str) -> pd.DataFrame:
    ...
    total_df.to_csv("C:/Users/akan2/Onedrive/Documents/Python/FlightTracker/data_to_ignore/out.zip",
